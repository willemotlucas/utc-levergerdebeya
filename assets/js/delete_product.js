$(document).ready(function() {
    $(document).on("click",".delete-product-button",function(event){
    	//Send get request to retrieve editio form
    	sendGET('Produit/admin_delete', event.target.id);
	});
	...
	$(document).on("click",".button-delete",function(){
    	...
    	sendPOST('Produit/admin_delete', data);
	});
