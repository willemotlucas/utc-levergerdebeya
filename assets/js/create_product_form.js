...
$('#help_picture').mouseover(function(){
	var element = document.getElementById("picture_message");
	element.innerHTML = "Veuillez sélectionner une image au format JPEG ou PNG. Cette image s'affichera dans les détails du produit.";
})
$('#help_picture').mouseout(function(){
	var element = document.getElementById("picture_message");
	element.innerHTML = "";
})
...
var validateForm = function(){
        $('.ui.admin.form.add.product').form({
		    on: 'blur',
		    fields: {
		      denomination_create: {
		        identifier : 'denomination_create',
		        rules: [
		          {
		            type : 'empty',
